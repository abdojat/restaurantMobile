...
class _FavoritesPageState extends State<FavoritesPage> with LocalizationMixin {
  ...
  void initState() {
    ...
    // Always show favorites only for this page
    controller.showFavoritesOnly = true;
    _loadData();
  }
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: getText('search_favorite_dishes'),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      '${items.length} ${getText('favorite_dishes')}',
                      style: TextStyle(
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return FoodCard(
                            ...
                            onFavoriteChanged: (isFavorite) {
                              // Update repository and refresh UI
                              FoodRepository.updateDishFavoriteStatus(
                                  item.id, isFavorite);
                              setState(() {
                                // Trigger UI refresh
                              });
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            getText('add_favorites_instruction'),
          ...
          ElevatedButton(
            ...
            child: Text(getText('browse_menu')),
          ),
        ],
      ),
    );
